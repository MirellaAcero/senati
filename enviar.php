...
<B>CARRERA:</B> = '.$administracion.' '.$agroindustria.' '.$artesgraficas.' '.$confecciones.' '.$confecciones.' '.$electrotecnia.' '.$hoteleria.' '.$alimentaria.' '.$informatica.' '.$joyeria.' '.$mecanica.' '.$metalmecanica.' '.$ambiental.' '.$textil.' <br>
...
mail($destinatario, "FORMULARIO DEL LANDING SENATI", $cuerpo, $headers);
?>

<html>
<script language="javascript">
document.location.href="respuesta.html#beneficios";
</script>
<body>
</body>
</html>