...
<B>CARRERA:</B> = '.$administracion2.' '.$agroindustria2.' '.$artesgraficas2.' '.$confecciones2.' '.$confecciones2.' '.$electrotecnia2.' '.$hoteleria2.' '.$alimentaria2.' '.$informatica2.' '.$joyeria2.' '.$mecanica2.' '.$metalmecanica2.' '.$ambiental2.' '.$textil2.' <br>
...
document.location.href="respuesta-2.html#sedes";
</script>
<body>
</body>
</html>